import 'dart:convert';
import 'package:trabajador_app/Views/Auth/register.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  login(String user, pass) async {
    ...
    String url =
        'https://finalproyecto.azurewebsites.net/api/Authenticate/login';
        ...
        body: SafeArea(
          child: Container(
            ...
            child: _isLoading
                ...
                : ListView(
                    children: [
                      const Icon(Icons.contact_phone_sharp, size: 200),
                      TextFormField(
